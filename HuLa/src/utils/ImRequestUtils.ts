...
import type { CacheBadgeReq, LoginUserReq, ModifyUserInfoType, RegisterResultVO, RegisterUserReq, UserItem } from '@/services/types'
...
export async function register(body: RegisterUserReq): Promise<RegisterResultVO> {
  return await imRequest<RegisterResultVO>({
